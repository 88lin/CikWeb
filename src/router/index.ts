...
export const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/agreement/cikgen-privacy',
    name: 'CikgenPrivacy',
    component: () => import('@/pages/agreement/CikgenPrivacy.vue'),
    meta: {
      title: 'CikGen密码生成器隐私协议',
      description: 'CikGen密码生成器隐私协议',
      keywords: 'CikGen, 密码生成器, 隐私协议',
    },
  },
  {
    path: '/404',
