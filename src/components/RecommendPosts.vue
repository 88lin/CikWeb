        ...
        <div class="category-column tech">
          <div class="column-header">
            ...
            <div class="header-text">
              ...
              <span class="column-count">{{ techPosts.length }} 篇文章</span>
            </div>
          </div>
        ...
        <div class="category-column tips">
          <div class="column-header">
            ...
            <div class="header-text">
              ...
              <span class="column-count">{{ tipsPosts.length }} 篇文章</span>
            </div>
          </div>
          <div class="posts-list">
            <a 
        ...
        <div class="category-column resource">
          <div class="column-header">
            ...
            <div class="header-text">
              ...
              <span class="column-count">{{ resourcePosts.length }} 篇文章</span>
            </div>
          </div>
          <div class="posts-list">
            <a 
