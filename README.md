...
3. **RecommendPosts** - 推荐文章（3栏分类列表）
   - 💻 技术分享
   - 📦 干货分享
   - 🎁 资源分享
4. **ProjectShow** - 项目深度展示容器
   - ToolsSection - 工具推荐
   - MediaSection - 社交媒体
   - LatestPosts - 最新文章
   - ThemesSection - 主题推荐
...
- `src/components/RecommendPosts.vue` - 首页推荐文章
...
<a href="https://edgeone.ai/?from=github/" target="_blank">
  <img src="public/edgeone-logo.svg" alt="Tencent EdgeOne" height="60" />
</a>
